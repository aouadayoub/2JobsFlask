...
import os
import logging
from ExtractSkills import GetSkillsResume
from process_prompt import ProcessPrompt, clean_job_title
from matching_json import MatchJobs, load_jobs_from_json, build_job_index
...
app.config['JOB_JSON_PATH'] = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'jobs_data.json'))
